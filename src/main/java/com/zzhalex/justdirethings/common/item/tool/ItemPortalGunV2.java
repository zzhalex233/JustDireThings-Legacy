...
public class ItemPortalGunV2 extends ItemFluidPoweredTool {
    ...
    public boolean spawnProjectile(World world, EntityPlayer player, ItemStack stack) {
        ...
        EntityPortalProjectile projectile = new EntityPortalProjectile(world, player, getOrCreatePortalGunId(stack), destination);
        ...
        linkData.setPrevious(PortalLinkData.PortalDestination.fromPlayer(player, "previous"));
    ...
    public int calculateFluidCost(EntityPlayer player, PortalLinkData.PortalDestination destination) {
        ...
        double dx = destination.getX() - player.posX;
        double dy = destination.getY() - player.posY;
        double dz = destination.getZ() - player.posZ;
    ...
    public void applyFavoriteUpdate(ItemStack stack, int favoriteIndex, NBTTagCompound favoriteTag) {
        ...
        if (favoriteTag != null && !favoriteTag.isEmpty()) {
            ...
            if (favoriteTag.getBoolean(FAVORITE_REMOVE)) {
                ...
                PortalLinkData.PortalDestination destination = PortalLinkData.PortalDestination.read(favoriteTag);
