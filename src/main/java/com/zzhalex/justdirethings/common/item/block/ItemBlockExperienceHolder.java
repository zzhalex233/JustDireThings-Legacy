...
public class ItemBlockExperienceHolder extends ItemBlock {

    private static final String TAG_MACHINE_DATA = "JDTExperienceHolderData";

    public ItemBlockExperienceHolder(Block block) {
        super(block);
    }
    ...
    public boolean placeBlockAt(ItemStack stack, EntityPlayer player, World world, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ, net.minecraft.block.state.IBlockState newState) {
        ...
        if (world.getTileEntity(pos) instanceof TileExperienceHolder) {
            TileExperienceHolder tile = (TileExperienceHolder) world.getTileEntity(pos);
    ...
    public static void writePortableData(ItemStack stack, TileExperienceHolder tile) {
