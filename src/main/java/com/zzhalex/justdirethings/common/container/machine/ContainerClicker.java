...
public class ContainerClicker extends ContainerMachineBase {

    private final TileClicker tile;

    public ContainerClicker(InventoryPlayer playerInventory, TileClicker tile) {
        super(playerInventory, tile, new InventoryBasic("clickert1", false, tile.getItemHandler().getSlots()));
        this.tile = tile;
